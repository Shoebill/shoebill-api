...
abstract class Label : Destroyable, Proxyable<Label> {
     ...
     */
    abstract fun attach(player: Player, offset: Vector3D = Vector3D())
     ...
     */
    @JvmOverloads
    fun attach(player: Player, x: Float = 0f, y: Float = 0f, z: Float = 0f) = attach(player, Vector3D(x, y, z))
     ...
     * @param offset The Location
     */
    abstract fun attach(vehicle: Vehicle, offset: Vector3D = Vector3D())
     ...
     */
    @JvmOverloads
    fun attach(vehicle: Vehicle, x: Float = 0f, y: Float = 0f, z: Float = 0f) = attach(vehicle, Vector3D(x, y, z))
