...
/**
 * This enum contains all available Skins from Grand Theft Auto: San Andreas. It might not include skins that were
 * introduced with SA:MP 0.3.7 or newer. This information was taken from the official SA:MP Wikipedia page.
 *
 * @author Trojaner25
...
enum class SkinModel(val id: Int, val description: String, val gender: SkinModel.Gender) {
    ...
    companion object : Collectable<SkinModel>, Findable<Int, SkinModel> {
        ...
        /**
         * Gets a [SkinModel] by its id.
         */
        @JvmStatic
        override operator fun get(value: Int): SkinModel? = VALUES[value]

        /**
         * Gets all available [SkinModel]s.
         */
        @JvmStatic
        override fun get(): Collection<SkinModel> = VALUES.values

        /**
         * Checks if the given SkinId is available.
         */
        @JvmStatic
        fun isValidSkin(id: Int): Boolean {
